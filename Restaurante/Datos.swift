...
class Datos {
    static var platillos : [Platillo] = [
        ...
        Platillo(nombre: "Hamburguesa con queso", imagenLista: UIImage(named: "hamburguesaLista")!, imagenDetalle: UIImage(named: "hamburguesaDetalle")!, descripcion: "Es una hamburguesa de pan bimbo y carne de la de bolsa", comentarios: [Comentario(usuario: "Jesus", comentario: "Estaba medio cruda")])
    ]
}
